...
var controlledChaos: AbilityNode = AbilityNode(
    ...
    changesInCharacterInfo = {abilities: CharacterInfo ->
        for (i in 0 until abilities.additionalAbilities.size) {
            if (abilities.additionalAbilities[i].contains("Ваше колдовство может вызвать волны дикой магии.")) {
                abilities.additionalAbilities[i] = abilities.additionalAbilities[i] + "\n" + "Каждый раз, когда вы совершаете бросок по таблице дикой магии, вы можете совершить два броска и использовать любой из двух."
            }
        }
        abilities
    },
